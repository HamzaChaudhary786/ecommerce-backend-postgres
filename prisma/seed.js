...
const seedData = async () => {
  try {
    ...
    await prisma.storeView.deleteMany();
    await prisma.sellerStore.deleteMany();
    await prisma.rFQQuoteRevision.deleteMany();
    await prisma.rFQMessage.deleteMany();
    await prisma.rFQSaved.deleteMany();
    await prisma.rFQActivityLog.deleteMany();
    ...
    await prisma.rFQBlockList.deleteMany();
